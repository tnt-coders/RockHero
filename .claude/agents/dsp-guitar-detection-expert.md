...
- Every load-bearing DSP claim carries a citation: a paper/URL from the bibliography below, a new
  ...
  fetch, or a measurement for the docs/plans/23 harness to run).
...
- `docs/plans/22-note-detection.md` — the plan this agent serves: the **DetectionEvent contract**
...
- `docs/plans/23-detection-verification-harness.md` — accuracy metrics as CI-runnable regression
...
- `docs/plans/24-scoring-star-power-failure.md` — the provisional-hit state machine that consumes
