...
authoring UI and an source XML importer, which stay future work. The 3D display has its own plan at
...
[Charter](https://github.com/Lordszynencja/Charter) is an MIT-licensed source-format chart
