...
contains a full source-game-to-draft-format conversion of the Marigold lead chart at
`song/charts/<uuid>.chart.json` — 1421 true-tab events flattened from 15 difficulty levels, 28
link chains merged into slide waypoints, 943 hand-warped beat markers compressed to 135 tempo anchors
