...
moved into `docs/in-progress/test-file-decomposition-plan.md`, and optional mock-framework
adoption is tracked separately in `docs/todo/trompeloeil-adoption-plan.md`.
...
The active follow-up is `docs/in-progress/test-file-decomposition-plan.md`.
...
decision is tracked by `docs/todo/trompeloeil-adoption-plan.md`.
