...
- Cache-pattern precedent: `AudioNormalization`
  ...
  (`docs/completed/backing-audio-minimal-normalization-metadata-plan.md`). Difficulty copies this
...
- `docs/user/difficulty-ratings.md` documents the 1-10 scale and tier table and still points at
  `docs/todo/arrangement-difficulty-derivation-plan.md` (now deleted — absorbed into this plan);
...
- **Cache-with-validity-marker pattern.** Difficulty is to the chart what normalization gain is
  ...
  `docs/completed/backing-audio-minimal-normalization-metadata-plan.md` and the absorbed
