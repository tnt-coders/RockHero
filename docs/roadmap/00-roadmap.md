...
| docs/roadmap/26-game-startup-menus-library.md | **Phases 1–3 complete + Phase 4 scan-roots/first-run 2026-07-12**; Phase 4 video/bindings deferred to consumers; Phases 5–8 unblocked (G20-RENDER closed); Phase 9 after 43 | Package peek reader, library index cache, scan, menus, Quick Play, onboarding, previews | Phase 1: extraction-free package description peek in common/core, single-site version gate, 6 tests green; song-root defaults decided (AppData primary + exe-relative songs/ secondary) |
