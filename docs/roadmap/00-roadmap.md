...
| docs/roadmap/20-game-architecture-and-render-stack.md | **G20-RENDER CLOSED (signed off 2026-07-10)** — Phases 1–4 ready | Platform scope, SDL3+bgfx spike, renderer-sharing seam, window/loop, resources, threading, dev diagnostics | Gate closed: SDL3+bgfx, loop L2, seam Option 1; architecture.md amended; game-render-expert created; plans 21/25/44 unblocked |
