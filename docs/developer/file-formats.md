...
stores at all is `notes[].held`, the stop under a right-hand onset, which rides the note it sits
under; everything else about a hand is derived, so there is no second array for any of it.
