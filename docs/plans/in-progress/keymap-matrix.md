...
> and for the MOVE verb, which is the one editing gesture that re-strikes by truncation and can
> clip payload, deliberately, since a moved note brings its own payload and there is nothing
> coherent to merge.
