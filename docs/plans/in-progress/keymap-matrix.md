...
| Keybind | Chart (highway) | Automation lanes | Tone strip | Status |
|---|---|---|---|---|
| `0`–`9` / numpad `0`–`9` | type **fret** at armed caret, or onto the selection — heads and the arpeggio bracket of a selected silently-held stop alike (2026-08-27) | open **value editor** at armed caret | `✗` | Live |
