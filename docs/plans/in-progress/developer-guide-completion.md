...
| 2 | `editor/core/project/` lifecycle | 15 files | **DONE 2026-07-15** | `docs/developer/the-project-lifecycle.md` — workspace model, .rhp vs .rock, open-flow diagram, deferred-action gate, save-is-export, importers, startup restore, dirty/fault interactions. View-state flux noted. |
