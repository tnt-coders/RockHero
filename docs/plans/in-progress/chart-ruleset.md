...
that reading. Tagged `sight/curtain-on-entry`.

THE LIFT, BUILT AND REJECTED THE SAME DAY (task #197). The symmetric half — the curtain lifting
past a span's close so a ribbon is curtained exactly where a span stands over it, the verdict
becoming per-note stretches and the board fading the ribbon back in over one lead before each
close — was built, sighted, and taken out on the user's verdict: "I sighted the curtain lift and I
actually don't like it." The spill clause therefore stands as written above: past the landmark the
curtain owns the ribbon to its presented end. The candidate the sighting pointed at instead is the
