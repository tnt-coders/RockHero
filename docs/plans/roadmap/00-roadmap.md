...
| **G57-BOARD** | docs/plans/roadmap/57-positions-past-the-drawn-board.md | 57-Q1 corpus measurement first (it may close the plan outright by shrinking the domain to the board), then 57-Q2..Q4 sign-off if a display mechanism is needed | 57 entirely; the interim (`highwayDrawnSoundingPosition` holding a node at the board's edge) shipped 2026-08-10 and stands meanwhile |
