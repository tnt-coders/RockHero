...
| docs/plans/roadmap/40-chart-editing.md | **Executing** (elevated to co-track priority with the detection/scoring chain, user 2026-07-16) | Full chart authorability: selection, notes, techniques, curves, templates/shapes/FHPs/sections, bulk edit | Phases 1–2 complete 2026-07-16 (grid arithmetic; mutable-chart pipeline: write-on-save, Session::currentChart + revision-keyed projection caches, byte-stable no-op saves); inventory re-verified; sequencing per 30-Q2: plan 30 Phases 1–2 next, then Phases 3+ |
