...
| **GATE-A (detection contract)** | docs/plans/roadmap/22-note-detection.md Phase 1 | Detectability matrix + per-register latency budget co-signed with plan 24 — **presented 2026-07-16** (dsp-expert-vetted, five adjustments folded into 22 Phase 1), awaiting user sign-off | 22 Phases 2+; 24 Phase 2 (provisional-hit machine); 23 Phases 1/2/6 (event schema, bot, metrics) |
