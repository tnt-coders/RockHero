...
| docs/plans/roadmap/61-span-marker-redesign.md | **TABLED 2026-09-05** (rides G60-RULINGS) | Roadmap seat for the span-marker/template redesign: markers as forced statement boundaries, grip templates + dictionary, template editor, signed boundary gestures, the closing hand coupling | Not started — source of truth stays `docs/plans/todo/span-marker-redesign.md` + `chord-dictionary.md`; executes as one arc with plan 60 Phase 3 per the three-beat ruling |
