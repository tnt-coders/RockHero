...
| docs/plans/roadmap/22-note-detection.md | Decision-gated (GATE-B remains) | Detection contract + latency budget, dry tap, algorithm survey, pipeline, v1 detectors, tuner, tuning gate | Phase 1 complete; **GATE-A CLOSED 2026-07-16 (user co-signed the vetted contract)** — Phases 2+ unblocked |
