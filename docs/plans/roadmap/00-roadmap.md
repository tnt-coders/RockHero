...
- **45-Q2** classic preset lanes 8–10: (A) keep the shipped Charter near-white gray 8th (also the CIELAB sweep's achromatic pick), chartreuse/indigo for 9/10; (B) the full RYB tier incl. magenta 8th, physically justified as of 2026-07-30 (the six rank-match the octave-folded open-string fundamentals; the fold terminates at six strings; lanes 7–10 are explicit false-color — note-format plan addendum). **Direction 2026-07-30: trial B rendered before signing; if magenta reads too hot, soften within-family first, fall back to A only if no variant reads calm.**
