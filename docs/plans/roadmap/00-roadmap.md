...
- **55-Q2** authoring. Mostly dissolved by the note-carried model (scrapes use ordinary note verbs); the remainder — the attack toggle with default-path synthesis and session-restorable overrides, path-waypoint editing, the transposition/retype pick-slide special case — folds into plan 40 Phase 5.
