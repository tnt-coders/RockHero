...
| docs/plans/roadmap/40-chart-editing.md | **Executing** (elevated to co-track priority with the detection/scoring chain, user 2026-07-16) | Full chart authorability: selection, notes, techniques, curves, templates/shapes/FHPs/sections, bulk edit | Phases 1–3 complete 2026-07-16 (grid arithmetic; mutable-chart pipeline; selection/caret/pointer input: headless gesture policy in the controller, hit testing via the shared layout manifest, marquee + caret overlays, arrow-key navigation); Phase 4 (first mutations with undo) next |
