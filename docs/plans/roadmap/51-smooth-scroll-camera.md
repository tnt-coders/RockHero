...
- 2026-07-03: both follow modes spiked over a bare waveform; shifted window adopted, smooth
  ...
  (docs/plans/todo/smooth-scroll-follow-evaluation.md, now superseded by this plan).
...
- 2026-07-14: **adoption reversed after further live use** — smooth-scrolling tablature proved
  ...
  game's territory (docs/plans/roadmap/30-game-2d-tab-view.md).
...
docs/plans/todo/smooth-scroll-follow-evaluation.md (already a pointer) and the roadmap status board;
