...
`docs/plans/in-progress/project-structure-cleanup-plan.md`; execute it from there against current code.
...
- `editor_controller.cpp` (3,552 lines) is the **deliberate root-facade end state** of the
  completed `docs/plans/completed/editor-runtime-extraction-plan.md`. Its policy clusters were already
...
- **Part A** — Engine implementation-seam decomposition in `common/audio`. Activates the
  `common/audio` items currently parked in `docs/plans/todo/editor-structure-deferred-work.md`
...
- The folder-grouping follow-ups in `docs/plans/todo/editor-structure-deferred-work.md` for `common/audio`
