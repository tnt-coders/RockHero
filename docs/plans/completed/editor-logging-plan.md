...
Status: completed (superseded approach), retired from `docs/plans/in-progress/` in Phase 0 of the editor undo
...
- The `docs/plans/todo/core-domain-logging-targets-plan.md` target split remains out of scope.
...
The broader `docs/plans/todo/core-domain-logging-targets-plan.md` is out of scope and appears stale
