...
tracked separately in `docs/plans/todo/plugin-window-persistence.md`. The "Project-level
...
persistence is deferred and tracked in `docs/plans/todo/plugin-window-persistence.md`.
