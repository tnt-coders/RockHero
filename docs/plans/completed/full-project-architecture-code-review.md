...
- `docs/plans/completed/test-support-cleanup-plan.md`
- `docs/plans/todo/trompeloeil-adoption-plan.md`
...
still the intended target. Do not routinely synchronize `docs/plans/todo/` plans; repository guidance
