...
earlier v2 draft (removed). This file and its companions all live in `docs/plans/completed/editor-undo/`
and are retained as the completed implementation record.

## Document map (all under `docs/plans/completed/editor-undo/`)
