...
Companion findings: `docs/plans/in-progress/project-structure-analysis.md` (2026-07-03 full-repo
...
`docs/plans/todo/remaining-god-object-decomposition-plan.md`: `engine_impl.h` (new), per-port TUs
...
`docs/plans/todo/editor-structure-deferred-work.md`: the `common/audio` grouping items move into this
...
1. Execute `docs/plans/todo/remaining-god-object-decomposition-plan.md` Part A (impl header, per-port
...
1. **Triage the clang-tidy header backlog.** The corrected `HeaderFilterRegex`
   ...
   `build/`.
2. Move `project-structure-analysis.md` and this plan to `docs/plans/completed/`; final
