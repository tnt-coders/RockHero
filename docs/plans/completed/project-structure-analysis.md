...
(`docs/plans/completed/architecture-patterns-and-naming-review{,-v2}.md`,
`docs/plans/completed/editor-runtime-extraction-plan.md`, `docs/plans/completed/public-header-surface-review.md`,
`docs/plans/completed/editor-structure-dropped-candidates.md`,
`docs/plans/todo/editor-structure-deferred-work.md`,
`docs/plans/todo/remaining-god-object-decomposition-plan.md`, and the two `docs/design/` architecture
documents).
...
5,906 lines, 8 ports, one TU. `docs/plans/todo/remaining-god-object-decomposition-plan.md` Part A
