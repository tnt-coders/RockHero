...
`docs/plans/in-progress/editor-core-framework-isolation-plan.md`, and
`docs/plans/in-progress/readability-taxonomy-evaluation-plan.md`. Test-specific follow-up planning lives
in `docs/plans/in-progress/test-file-decomposition-plan.md`.
...
`docs/plans/completed/architecture-patterns-and-naming-review.md` was consulted. Where the two reviews
...
tracked by `docs/plans/todo/trompeloeil-adoption-plan.md`.
...
`docs/plans/in-progress/test-file-decomposition-plan.md`.
