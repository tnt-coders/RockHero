...
/*!
\brief Hidden Tracktion plugin that scales one multi-tone rack branch by its audibility.
...
and it is the whole of what this plugin does: a tone's own level is a gain plugin inside that tone's
chain, like any other block. `LiveRigGainPlugin` is the message-thread dB trim for the rig's input
stage and for the post-rack monitor stage, neither of which belongs to any tone.
*/
