...
public:
    ...
    */
    ...
    \return DeviceRestoreOutcome::Opened, DeviceRestoreOutcome::DeviceUnavailable (device left
            closed, saved choice retained), or a typed failure when the route could not be applied.
    */
