...
std::string_view TabView::cycleGhostStyle()
{
    m_ghost_style = (m_ghost_style + 1) % common::ui::tabGhostStyleCount();
    repaint();
    return common::ui::tabGhostStyleName(m_ghost_style);
}
...
void TabView::paint(juce::Graphics& g)
{
    ...
    const common::ui::TabLaneMetrics metrics = common::ui::makeTabLaneMetrics(
        ...
        displayed_count,
        m_tab->string_count,
        common::ui::TabLaneStyle{.ghost_style = m_ghost_style});
