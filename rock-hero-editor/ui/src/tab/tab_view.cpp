...
// the source game's six standard string colors, ordered from the sixth-highest displayed lane upward:
    ...
    float center_y, juce::Colour lane_color)
{
    ...
    {
        // Natural harmonics take the source game's diamond silhouette; widen the diamond so its
