...
public:
    ...
    */
    ...
    /*!
    \brief Claims F9 for the accent-intensity sighting rig (SIGHTING RIG - DELETE WITH IT).
    ...
    answers it for the focused-editor case, so the rung advances either way.
