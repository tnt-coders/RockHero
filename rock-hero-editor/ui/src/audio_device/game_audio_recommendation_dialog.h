...
and an "Open Audio Settings" decline path as buttons (the view follows the decline by opening the
audio device settings window), plus a "don't show this message again" checkbox whose value is
