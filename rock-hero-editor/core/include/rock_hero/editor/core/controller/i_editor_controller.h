...
public:
    ...
    */
    virtual void onToneAutomationPointerMove(const ToneAutomationPointerEvent& event) = 0;

    /*! \brief Handles the pointer leaving the automation lanes, clearing any Alt insert ghost. */
