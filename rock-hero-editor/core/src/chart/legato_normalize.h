...
both attacks and a tap is a picking-hand articulation no predecessor can rescue into a pull. Every
other `Hammer` is untouched — always possible as a left-hand tap, so a deliberate `Ctrl+H` survives
every later edit. Judgments are value-based against the RELEASED fret (a glide hands over its last
waypoint, a scrape its slide-out's end), never predecessor identity, and a valid pull-from-a-scrape
